...
//   {
//     title:
//       "Strategic SEO delivers +60% month-on-month organic growth for Starbucks",
//     client: "Starbucks",
//     description:
//       "We began with a comprehensive site audit to uncover key growth opportunities.From eliminating toxic backlinks to executing a robust pillar-cluster content strategy, every step was designed to strengthen authority and relevance.A large-scale internal linking initiative significantly improved indexation, visibility, and organic performance — driving consistent, compounding growth.",
//   },
//   {
//     title:
//       "SEO boosts organic traffic by over +15% in only 7 months for Tata Communications.",
...
//     description: (
//       <>
//         <span>We began with a comprehensive site audit to uncover key growth
//         opportunities. From eliminating toxic backlinks to executing a robust{" "}
//         <strong>pillar-cluster content strategy</strong>, every step was designed
//         to strengthen authority and relevance.</span>
//         <br/>
//         <span> A large-scale internal linking
//         initiative significantly improved indexation, visibility, and organic
//         performance — driving consistent, compounding growth.</span>
//       </>
//     ),
//   },
//   {
...
//     (
//       <>
//         <span>We optimized onsite SEO, fixed technical issues, and implemented a strategic backlinking plan to enhance keyword focus.</span>
//         <br/>
//         <span>Our approach aligned with their business goals, addressing key challenges while seamlessly improving traffic, search rankings, and conversions.</span>
//       </>
//     ),
//   },
//   {
...
//     (
//       <>
//         <span> In-depth research helped us understand user intent and analyze content gaps. Our scalable content roadmap enhanced semantic authority through search query chains</span>
//         <br/>
//         <span>We strengthened domain authority with a robust offsite marketing strategy and implemented technical SEO best practices.
// </span>
//       </>
//     ),
...
//     (
//       <>
//         <span> We identified and removed duplicate content issues while systematically improving Core Web Vitals. </span>
//         <br/>
//         <span>We optimized and repurposed existing content, created new content for long-tail queries, and built optimized pillar pages for competitive head terms.
// </span>
//       </>
//     ),
//   },
